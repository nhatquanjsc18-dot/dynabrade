        ...
        <div ref={searchRef} className="relative flex items-center">
          <form
            ...
            className={`flex items-center overflow-hidden transition-all duration-200 ${
              searchOpen ? "w-[220px] sm:w-[280px] opacity-100" : "w-0 opacity-0"
            }`}
          >
            <input
              ref={searchInputRef}
              ...
              placeholder="Tìm sản phẩm hoặc mã REF..."
              className="w-full text-[0.85rem] px-4 py-2.5 border-[1.5px] border-[var(--line)] rounded-full bg-[var(--surface)] text-[var(--text)] outline-none focus:border-[var(--accent)]"
            />
          </form>
          <button
            type="button"
            ...
            className={`flex-none flex items-center justify-center w-[42px] h-[42px] rounded-full transition ${
              searchOpen
                ? "bg-[var(--accent)] text-[#fff6ee] ml-2"
                : "bg-[var(--accent)] text-[#fff6ee]"
            }`}
          >
